...
utils.waitUntil(function() {
  ...
  utils.waitForElement('#shopping-bag-promo-box').then(function(element) {
    document.querySelector('#shopping-bag-promo-box').insertAdjacentHTML('afterend',brongSavingsCalcContent);
  });
//   console.log("%c%s","color: green; background: yellow; font-size: 24px;",'Hi');
